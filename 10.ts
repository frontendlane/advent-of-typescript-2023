...
type LastWord<T extends string> = T extends `${string} ${infer Rest}` ? LastWord<Rest> : T

type StreetSuffixTester<Street extends string, Suffix extends string> = LastWord<Street> extends Suffix ? true : false;